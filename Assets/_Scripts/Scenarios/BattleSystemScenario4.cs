...
public class BattleSystemScenario4 : BattleSystem
{
...
#region Methods
    ...
    private void EndBattle() //End Battle Check
    {
        ...
        {
            PlayerUnit.UnitStats.playerCoins += Random.Range(10, 60);
            PlayerHUD.SetCoins();
...
#region Coroutines
    IEnumerator SetupBattle() //Setting Up the Battle
    {
        ...
        GameObject enemy1Go = Instantiate(Enemy1Prefab[Random.Range(0, 1)], Enemy1SpawnPoint);
